    ...
    a.fn.dropdown = function(b) {
        ...
        this.each(function() {
            ...
            function e() {
                d(),
                i.addClass("active"),
                h.constrain_width === !0 && i.css("width", g.outerWidth());
                var b = 0;
        ...
        init: function(b) {
            ...
            a(this).each(function() {
                ...
                e.hasClass("fixed") && a(window).resize(function() {
                    window.innerWidth > 992 ? 0 !== a("#sidenav-overlay").css("opacity") && g ? c(!0) : (e.removeAttr("style"),
                    e.css("width", b.menuWidth)) : g === !1 && ("left" === b.edge ? e.css("left", -1 * (b.menuWidth + 10)) : e.css("right", -1 * (b.menuWidth + 10)))
                }),
                ...
                a(".drag-target").hammer({
                    ...
                    if ("touch" == d.gesture.pointerType) {
                        ...
                        "left" === b.edge)
                            f < b.menuWidth / 2 ? g = !1 : f >= b.menuWidth / 2 && (g = !0),
...
function(a) {
    a(document).ready(function() {
        ...
        a(document).on("change", c, function() {
            (0 !== a(this).val().length || void 0 !== a(this).attr("placeholder")) && a(this).siblings("label, i").addClass("active"),
    ...
    a.fn.material_select = function(b) {
        a(this).each(function() {
            ...
            !$select.hasClass("browser-default")) {
                ...
                if (c && ($select.parent().find("i").remove(),
                ...
                onKeyDown = function(b) {
                    if (9 == b.which)
                        return void j.trigger("close");
                    if (40 == b.which && !g.is(":visible"))
                        return void j.trigger("open");
    ...
    var b = {
        init: function(b) {
            ...
            this.each(function() {
                ...
                if (-1 != i && (e = h.eq(i)),
                f.hasClass("fullscreen") || (f.height(b.indicators ? b.height + 40 : b.height),
                g.height(b.height)),
