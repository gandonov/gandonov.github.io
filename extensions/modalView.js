...
TestView = Framework.BaseView.extend({

    render : function(){
        Framework.BaseView.prototype.render.call(this);
        this.$el.html('test view rendered.');
    }

});

MaterializeModal = Framework.AbstractModal.extend({
    template : 'templates/modals/MaterializeModal.html',
    dismissible: true,
    in_duration : 200,
    out_duration : 200,
    fixedFooter : false,
    render : function(){
        AbstractModal.prototype.render.call(this);
        $('body').append(this.$el);
